...
Door deze  toepassing weten we dat het relatief eenvoudig is om met openpose zinvolle berekeningen te kunnen doen. Door de coördinaten die gegeven worden als output kunnen we gemakkelijk programma's schrijven die hiermee werken. Doordat Openpose werkt in 2D hebben we gemerkt dat de foto recht moet genomen worden. Als de hoek die we willen bereken schuin afgebeeld staat op de inputfoto komt de berekening helemaal niet overeen met de werkelijke waarde van de hoek.
